...
function scoreboardIDpage() {
  const router = useRouter();
  const scoreboardIDpage = router.query.scoreboardIDpage;
        ...
        >
          <Card align="center" w="50vw">
            ...
            <CardFooter>
              ...
              <Button ml={10} colorScheme="blue" onClick={setWinnerToFalse}>
                Save
              </Button>
            </CardFooter>
          </Card>
...
// /scoreboardForFB/this_is_id
export default scoreboardIDpage;
